...
to SQL databases or other databases in general is that it is created to support agility. It is built to support large amounts of
new and changeing data. NoSQL databases have many different types of data in them unlike a classic SQL database, NoSQL adapts to 
...
server rather than being able to add new ones in; as the data does not accomodate new servers.
